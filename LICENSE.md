Apache License
   ...
   1. Definitions.
      ...
      editorial revisions, annotations, or other modifications
      represent, as a whole, an an original work of authorship. For purposes
   ...
   4. Redistribution. You may reproduce and distribute copies of the
      ...
      (d) If the Work includes a "NOTICE" text file as part of its
          ...
          in that NOTICE file, excluding those notices that do not pertain to
          ...
          alongside or as an addition to the NOTICE text from the Work, provided
   ...
   APPENDIX: How to apply the Apache License to your work.
      ...
      copy of the License be included in the root of the source
      distribution.

   Copyright 2025 LexsightLLC
